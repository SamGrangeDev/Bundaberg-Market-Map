...
//ol.proj.get("EPSG:7855").setExtent([953295.340611, 7189788.988906, 1106106.418908, 7266576.078811]);
var wms_layers = [];
...
var format_MajorLandOwner_75 = new ol.format.GeoJSON();
var features_MajorLandOwner_75 = format_MajorLandOwner_75.readFeatures(json_MajorLandOwner_75, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:7855'});
var jsonSource_MajorLandOwner_75 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_MajorLandOwner_75.addFeatures(features_MajorLandOwner_75);
var lyr_MajorLandOwner_75 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_MajorLandOwner_75, 
                style: style_MajorLandOwner_75,
                popuplayertitle: "Major Land Owner",
                interactive: false,
    title: 'Major Land Owner<br />\
    <img src="styles/legend/MajorLandOwner_75_0.png" /> Craig Michael DerepazDebbie Maree Derepas<br />\
    <img src="styles/legend/MajorLandOwner_75_1.png" /> Giovanni Santalucia<br />\
    <img src="styles/legend/MajorLandOwner_75_2.png" /> Jeanne Eloise Strahan<br />'
        });
...
var format_Zoned_77 = new ol.format.GeoJSON();
var features_Zoned_77 = format_Zoned_77.readFeatures(json_Zoned_77, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:7855'});
var jsonSource_Zoned_77 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Zoned_77.addFeatures(features_Zoned_77);
var lyr_Zoned_77 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Zoned_77, 
                style: style_Zoned_77,
                popuplayertitle: "Zoned",
                interactive: true,
                title: '<img src="styles/legend/Zoned_77.png" /> Zoned'
            });
var format_EstateLabel_78 = new ol.format.GeoJSON();
var features_EstateLabel_78 = format_EstateLabel_78.readFeatures(json_EstateLabel_78, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:7855'});
var jsonSource_EstateLabel_78 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_EstateLabel_78.addFeatures(features_EstateLabel_78);
var lyr_EstateLabel_78 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_EstateLabel_78, 
                style: style_EstateLabel_78,
                popuplayertitle: "Estate Label",
                interactive: false,
                title: '<img src="styles/legend/EstateLabel_78.png" /> Estate Label'
            });
var format_ParcelAttributesLabel_79 = new ol.format.GeoJSON();
var features_ParcelAttributesLabel_79 = format_ParcelAttributesLabel_79.readFeatures(json_ParcelAttributesLabel_79, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:7855'});
var jsonSource_ParcelAttributesLabel_79 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ParcelAttributesLabel_79.addFeatures(features_ParcelAttributesLabel_79);
var lyr_ParcelAttributesLabel_79 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ParcelAttributesLabel_79, 
                style: style_ParcelAttributesLabel_79,
                popuplayertitle: "Parcel Attributes Label",
                interactive: false,
                title: '<img src="styles/legend/ParcelAttributesLabel_79.png" /> Parcel Attributes Label'
            });
var group_LabelSwitch = new ol.layer.Group({
                                layers: [lyr_EstateLabel_78,lyr_ParcelAttributesLabel_79,],
                                fold: "open",
                                title: "Label Switch"});
var group_ParcelAttributes = new ol.layer.Group({
                                layers: [lyr_Unzoned_76,lyr_Zoned_77,],
                                fold: "open",
                                title: "Parcel Attributes"});
var group_Administrative = new ol.layer.Group({
                                layers: [lyr_Suburb_71,lyr_LGA_72,lyr_PropertyBoundaries_73,lyr_Estate_74,lyr_MajorLandOwner_75,],
                                fold: "open",
...
lyr_PropertyBoundaries_73.set('fieldAliases', {'fid': 'fid', 'OBJECTID': 'OBJECTID', 'PARCEL': 'PARCEL', 'Address': 'ADDRESS', 'full_address': 'FULL_ADDRESS', 'Zoned/Unzoned': 'Zoned/Unzoned', 'Zoning': 'Zoning', 'Strategy': 'Strategy', 'Strat Link': 'Strat Link', 'Overlays': 'Overlays', 'Gross HA': 'Gross HA', 'NDH': 'NDH', 'Lot Yield @ 20dw/HA (350m2)': 'Lot Yield @ 20dw/HA (350m2)', 'VALUE @ 350m2': 'VALUE @ 350m2', 'Market Value (20%DM)': 'Market Value (20%DM)', 'Current RLP': 'Current RLP', 'Current OPC': 'Current OPC', 'Market Value (30%DM)': 'Market Value (30%DM)', 'Market Value (25%DM)': 'Market Value (25%DM)', 'Market Value (15%DM)': 'Market Value (15%DM)', 'Market Value (12%DM)': 'Market Value (12%DM)', 'Market Value (10%DM)': 'Market Value (10%DM)', 'OWNERSHIP': 'OWNERSHIP', 'Estate Status': 'Estate Status', 'Developer': 'Developer', 'Vendor Company': 'Vendor Company', 'Vendor Names': 'Vendor Names', 'Vendor Address': 'Vendor Address', 'Vendor Mobile': 'Vendor Mobile', 'Vendor Email': 'Vendor Email', 'Lead Link': 'Lead Link', 'plan_lot': 'PLAN_LOT', 'derm_landuse': 'DERM_LANDUSE', 'house_no': 'HOUSE_NO', 'street_name': 'STREET_NAME', 'street_type': 'STREET_TYPE', 'road_name': 'ROAD_NAME', 'locality': 'LOCALITY', 'legal_area': 'LEGAL_AREA', 'Shape_Length': 'Shape_Length', 'Shape_Area': 'Shape_Area', 'Major Land Owner': 'Major Land Owner', });
lyr_Estate_74.set('fieldAliases', {'Estate': 'Estate', 'Status': 'Status', 'Developer': 'Developer', });
lyr_MajorLandOwner_75.set('fieldAliases', {'fid': 'fid', 'OBJECTID': 'OBJECTID', 'PARCEL': 'PARCEL', 'Address': 'Address', 'Zoned/Unzoned': 'Zoned/Unzoned', 'Zoning': 'Zoning', 'Strategy': 'Strategy', 'Strat Link': 'Strat Link', 'Overlays': 'Overlays', 'Gross HA': 'Gross HA', 'NDH': 'NDH', 'Lot Yield @ 20dw/HA (350m2)': 'Lot Yield @ 20dw/HA (350m2)', 'VALUE @ 350m2': 'VALUE @ 350m2', 'Market Value (20%DM)': 'Market Value (20%DM)', 'Current RLP': 'Current RLP', 'Current OPC': 'Current OPC', 'Market Value (30%DM)': 'Market Value (30%DM)', 'Market Value (25%DM)': 'Market Value (25%DM)', 'Market Value (15%DM)': 'Market Value (15%DM)', 'Market Value (12%DM)': 'Market Value (12%DM)', 'Market Value (10%DM)': 'Market Value (10%DM)', 'OWNERSHIP': 'OWNERSHIP', 'Estate Status': 'Estate Status', 'Developer': 'Developer', 'Vendor Company': 'Vendor Company', 'Vendor Names': 'Vendor Names', 'Vendor Address': 'Vendor Address', 'Vendor Mobile': 'Vendor Mobile', 'Vendor Email': 'Vendor Email', 'Lead Link': 'Lead Link', 'plan_lot': 'plan_lot', 'derm_landuse': 'derm_landuse', 'house_no': 'house_no', 'street_name': 'street_name', 'street_type': 'street_type', 'road_name': 'road_name', 'locality': 'locality', 'legal_area': 'legal_area', 'Shape_Length': 'Shape_Length', 'Shape_Area': 'Shape_Area', 'Major Land Owner': 'Major Land Owner', });
lyr_Unzoned_76.set('fieldAliases', {'fid': 'fid', 'OBJECTID': 'OBJECTID', 'PARCEL': 'PARCEL', 'Address': 'Address', 'Zoned/Unzoned': 'Zoned/Unzoned', 'Zoning': 'Zoning', 'Strategy': 'Strategy', 'Strat Link': 'Strat Link', 'Overlays': 'Overlays', 'Gross HA': 'Gross HA', 'NDH': 'NDH', 'Lot Yield @ 20dw/HA (350m2)': 'Lot Yield @ 20dw/HA (350m2)', 'VALUE @ 350m2': 'VALUE @ 350m2', 'Market Value (20%DM)': 'Market Value (20%DM)', 'Current RLP': 'Current RLP', 'Current OPC': 'Current OPC', 'Market Value (30%DM)': 'Market Value (30%DM)', 'Market Value (25%DM)': 'Market Value (25%DM)', 'Market Value (15%DM)': 'Market Value (15%DM)', 'Market Value (12%DM)': 'Market Value (12%DM)', 'Market Value (10%DM)': 'Market Value (10%DM)', 'OWNERSHIP': 'OWNERSHIP', 'Estate Status': 'Estate Status', 'Developer': 'Developer', 'Vendor Company': 'Vendor Company', 'Vendor Names': 'Vendor Names', 'Vendor Address': 'Vendor Address', 'Vendor Mobile': 'Vendor Mobile', 'Vendor Email': 'Vendor Email', 'Lead Link': 'Lead Link', 'plan_lot': 'plan_lot', 'derm_landuse': 'derm_landuse', 'house_no': 'house_no', 'street_name': 'street_name', 'street_type': 'street_type', 'road_name': 'road_name', 'locality': 'locality', 'legal_area': 'legal_area', 'Shape_Length': 'Shape_Length', 'Shape_Area': 'Shape_Area', 'Major Land Owner': 'Major Land Owner', });
lyr_Zoned_77.set('fieldAliases', {'fid': 'fid', 'OBJECTID': 'OBJECTID', 'PARCEL': 'PARCEL', 'Address': 'Address', 'Zoned/Unzoned': 'Zoned/Unzoned', 'Zoning': 'Zoning', 'Strategy': 'Strategy', 'Strat Link': 'Strat Link', 'Overlays': 'Overlays', 'Gross HA': 'Gross HA', 'NDH': 'NDH', 'Lot Yield @ 20dw/HA (350m2)': 'Lot Yield @ 20dw/HA (350m2)', 'VALUE @ 350m2': 'VALUE @ 350m2', 'Market Value (20%DM)': 'Market Value (20%DM)', 'Current RLP': 'Current RLP', 'Current OPC': 'Current OPC', 'Market Value (30%DM)': 'Market Value (30%DM)', 'Market Value (25%DM)': 'Market Value (25%DM)', 'Market Value (15%DM)': 'Market Value (15%DM)', 'Market Value (12%DM)': 'Market Value (12%DM)', 'Market Value (10%DM)': 'Market Value (10%DM)', 'OWNERSHIP': 'OWNERSHIP', 'Estate Status': 'Estate Status', 'Developer': 'Developer', 'Vendor Company': 'Vendor Company', 'Vendor Names': 'Vendor Names', 'Vendor Address': 'Vendor Address', 'Vendor Mobile': 'Vendor Mobile', 'Vendor Email': 'Vendor Email', 'Lead Link': 'Lead Link', 'plan_lot': 'plan_lot', 'derm_landuse': 'derm_landuse', 'house_no': 'house_no', 'street_name': 'street_name', 'street_type': 'street_type', 'road_name': 'road_name', 'locality': 'locality', 'legal_area': 'legal_area', 'Shape_Length': 'Shape_Length', 'Shape_Area': 'Shape_Area', 'Major Land Owner': 'Major Land Owner', });
lyr_EstateLabel_78.set('fieldAliases', {'fid': 'fid', 'Estate': 'Estate', 'Status': 'Status', 'Developer': 'Developer', });
lyr_ParcelAttributesLabel_79.set('fieldAliases', {'fid': 'fid', 'OBJECTID': 'OBJECTID', 'PARCEL': 'PARCEL', 'Address': 'Address', 'Zoned/Unzoned': 'Zoned/Unzoned', 'Zoning': 'Zoning', 'Strategy': 'Strategy', 'Strat Link': 'Strat Link', 'Overlays': 'Overlays', 'Gross HA': 'Gross HA', 'NDH': 'NDH', 'Lot Yield @ 20dw/HA (350m2)': 'Lot Yield @ 20dw/HA (350m2)', 'VALUE @ 350m2': 'VALUE @ 350m2', 'Market Value (20%DM)': 'Market Value (20%DM)', 'Current RLP': 'Current RLP', 'Current OPC': 'Current OPC', 'Market Value (30%DM)': 'Market Value (30%DM)', 'Market Value (25%DM)': 'Market Value (25%DM)', 'Market Value (15%DM)': 'Market Value (15%DM)', 'Market Value (12%DM)': 'Market Value (12%DM)', 'Market Value (10%DM)': 'Market Value (10%DM)', 'OWNERSHIP': 'OWNERSHIP', 'Estate Status': 'Estate Status', 'Developer': 'Developer', 'Vendor Company': 'Vendor Company', 'Vendor Names': 'Vendor Names', 'Vendor Address': 'Vendor Address', 'Vendor Mobile': 'Vendor Mobile', 'Vendor Email': 'Vendor Email', 'Lead Link': 'Lead Link', 'plan_lot': 'plan_lot', 'derm_landuse': 'derm_landuse', 'house_no': 'house_no', 'street_name': 'street_name', 'street_type': 'street_type', 'road_name': 'road_name', 'locality': 'locality', 'legal_area': 'legal_area', 'Shape_Length': 'Shape_Length', 'Shape_Area': 'Shape_Area', 'Major Land Owner': 'Major Land Owner', });
